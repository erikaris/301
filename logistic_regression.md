...
Your DV must be coded as 0 and 1. SPSS predicts membership in the **higher-coded** category. So make sure:
- 1 = the outcome you are trying to predict (e.g. 1 = voted)
- 0 = the comparison group (e.g. 0 = did not vote)

Check this with `Analyze → Descriptive Statistics → Frequencies` and confirm your coding before proceeding.
