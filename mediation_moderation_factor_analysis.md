...
These two are very commonly confused because both involve three variables. The difference is in the **question being asked**.

---

### The question each analysis asks

| | Mediation | Moderation |
|---|---|---|
| **The question** | *Why* does X affect Y? What is the mechanism? | *When* or *for whom* does X affect Y? Under what conditions? |
| **What the third variable does** | It **carries** the effect — X works *through* M to reach Y | It **changes** the effect — M turns the X → Y relationship up or down |
| **Where the third variable sits** | In the middle of a causal chain | Alongside — it does not sit between X and Y |
| **What you are testing** | Whether the indirect path X → M → Y is significant | Whether the X × W interaction term is significant |

---

### Visualising the difference

**Mediation — M is in the causal chain:**
...
The claim is: workload causes poor coping, and poor coping causes burnout. Coping is the *mechanism* explaining *why* workload leads to burnout.

**Moderation — W changes the strength of the arrow:**
...
```
                  Social Support (W)
                         ...
                         ▼
X ═══════════════════════════════════► Y
(Workload)        (the effect         (Burnout)
               gets bigger or
               smaller depending on W)
```

The claim is: workload causes burnout, but *how much* depends on social support. High support weakens the effect. Low support strengthens it. Social support is not in the middle — it changes the dial.

---

### Using the same dataset: two different questions

| Analysis | Question being asked | Third variable |
|---|---|---|
| **Mediation** | Does workload increase burnout *because* it reduces coping ability? | Coping (M) — the mechanism |
| **Moderation** | Does workload increase burnout, and is this effect *stronger when social support is low*? | Social Support (W) — the condition |
